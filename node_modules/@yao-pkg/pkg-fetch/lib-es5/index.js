...
exports.system = exports.need = exports.getNodeVersion = exports.satisfyingNodeVersion = void 0;
var fs_1 = require("fs");
...
function satisfyingNodeVersion(nodeRange) {
    ...
    if (!nodeVersion) {
        throw (0, log_1.wasReported)("No available node version satisfies '".concat(nodeRange, "'"));
    }
    return nodeVersion;
}
exports.satisfyingNodeVersion = satisfyingNodeVersion;
function getNodeVersion(nodeRange) {
    ...
    if (nodeRange !== 'latest') {
        nodeRange = "v".concat(nodeRange.slice(4)); // 'node6' -> 'v6' for semver
    }
    var nodeVersion = satisfyingNodeVersion(nodeRange);
    return nodeVersion;
}
...
function need(opts) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _a = opts || {}, forceFetch = _a.forceFetch, forceBuild = _a.forceBuild, dryRun = _a.dryRun, output = _a.output, nodeRange = _a.nodeRange;
                    _b = opts || {}, platform = _b.platform, arch = _b.arch;
                    if (!nodeRange)
                    ...
                    nodeVersion = getNodeVersion(nodeRange);
                ...
                case 10:
                    ...
                    if (system_1.hostPlatform !== platform) {
                        if (system_1.hostPlatform !== 'alpine' || platform !== 'linuxstatic') {
                            throw (0, log_1.wasReported)("Not able to build for '".concat(opts.platform, "' here, only for '").concat(system_1.hostPlatform, "'"));
                        }
                    }
                    if (system_1.knownArchs.indexOf(arch) < 0) {
                        throw (0, log_1.wasReported)("Unknown arch '".concat(opts.arch, "'. Specify ").concat(system_1.knownArchs.join(', ')));
                    }
                    if (dryRun) {
                        return [2 /*return*/, 'built'];
                    }
