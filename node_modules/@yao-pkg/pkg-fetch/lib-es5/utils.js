            ...
            switch (_d.label) {
                ...
                case 1:
                    ...
                    if (!res.ok) {
                        ...
                        throw (0, log_1.wasReported)("".concat(res.status, ": ").concat(res.statusText));
                    }
                    tempFile = "".concat(file, ".downloading");
                    (0, fs_1.mkdirSync)(path_1.default.dirname(tempFile), { recursive: true });
                    ws = (0, fs_1.createWriteStream)(tempFile);
                    ...
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            stream_1.default.finished(ws, function (err) {
                                if (err) {
                                    ...
                                    reject((0, log_1.wasReported)("".concat(err.name, ": ").concat(err.message)));
                                }
                                else {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    ...
                    var input = (0, fs_1.createReadStream)(filePath);
...
function plusx(file) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, promises_1.stat)(file)];
                case 1:
                    s = _a.sent();
                    ...
                    return [4 /*yield*/, (0, promises_1.chmod)(file, base8)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function nodeBinarySortFunction(a, b) {
    var coercedVersionA = (0, semver_1.coerce)(a);
    var coercedVersionB = (0, semver_1.coerce)(b);
